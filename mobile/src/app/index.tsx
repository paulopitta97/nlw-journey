...
export default function Index() {
    ...
    function handleNextStepForm() {
        if(destination.trim().length === 0 || !selectedDates.startsAt || !selectedDates.endsAt ) {
            return Alert.alert("Detalhes da viagem", "Preencha todas as informações da viagem para prosseguir.")
        }
    ...
    return (
        <View className="flex-1 items-center justify-center px-5">
            ...
            <Modal 
                ...
                subtitle="Os convidados receberão e-mails para confirmar a participação na viagem." 
