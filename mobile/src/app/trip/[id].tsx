...
export default function Trip() {
    ...
    async function handleUpdateTrip() {
        try{
            ...
            if(!destination || !selectedDates.startsAt || !selectedDates.endsAt) {
                return Alert.alert("Atualizar viagem", "Lembre-se de, além de preencher o destino, selecionar a data de início e término da viagem.")
            }
    ...
    async function handleConfirmationAttendance() {
        try{
            ...
            if(!validateInput.email(guestEmail.trim())) {
                return Alert.alert("Confirmação", "Preencha um e e-mail válido!")
            }
                ...
                <View className="gap-4 mt-4">
                    <Text className="text-zinc-400 font-regular leading-6 my-2">
                        ...
                        <Text className="font-semibold text-zinc-100">
                            {dayjs(tripDetails.starts_at).date()} a {dayjs(tripDetails.ends_at).date()} de {dayjs(tripDetails.ends_at).format('MMMM')}.{"\n\n"}
                        </Text>
                    ...
                    <Button isLoading={isConfirmingAttendance} onPress={handleConfirmationAttendance}>
